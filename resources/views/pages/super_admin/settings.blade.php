...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title font-weight-semibold">Cập nhật cài đặt hệ thống</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="row">
                <div class="col-md-8 border-right-2 border-right-blue-400">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label font-weight-semibold">Tên Trường <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <input name="system_name" value="{{ $s['system_name'] }}" required type="text" class="form-control" placeholder="Name of School">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">Niên khóa hiện tại <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label font-weight-semibold">Viết tắt tên trường</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="system_footer" value="{{ $s['system_footer'] }}" required type="text" class="form-control" placeholder="Name of School">
                        </div>
                    </div>
                    {{-- <div class="form-group row">
